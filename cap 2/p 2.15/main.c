...
/* Spa.
El programa, al recibir comomdato el tipo de tratamiento, la edad y el numero de dias de internacion de un cliente en un spa,
calcula el costo total del tratamiento.

TRA, EDAD, DIA: variables de tipo entero.
