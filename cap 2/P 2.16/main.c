...
/*Empresa textil.
El programa,al recibir coomo datos decisivos la categoria y antiguedad de un empreado,
determina si el mismk reune las condiciones establecidas por la empresa
